...
interface HistoryPostTestColumnProps {
  deleteHistoryPostTestHandler: (data: HistoryPostTest) => void;
}

export const historyPostTestColumns = (
  props: HistoryPostTestColumnProps,
): ColumnDef<HistoryPostTest>[] => [
  {
    accessorKey: "index",
    header: "No",
    cell: ({ row }) => {
    ...
    cell: ({ row }) => {
      ...
      return (
        <ActionButton>
          ...
          <div
            onClick={() => props.deleteHistoryPostTestHandler(data)}
